...
bool create_window(SDL_Window *&window, SDL_Renderer *&renderer)
{
    ...
    window = SDL_CreateWindow("DMG VRAM Viewer", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 512, 512, 0);
...
int main(int argc, char **argv)
{
    ...
    SDL_Texture *texture {SDL_CreateTexture(renderer, SDL_PIXELFORMAT_RGBA32, SDL_TEXTUREACCESS_STATIC, TEXTURE_WIDTH, TEXTURE_HEIGHT)};
    if (!texture) {
